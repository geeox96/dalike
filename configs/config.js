module.exports = {
	...
	"bot_mode_options": {
		"likemode_realistic": {
			"hashtags": ["vaporbrasil", "juicebr", "vapebrasil", "vapebr", "vapebrazil", "vaper", "vaperbrasil", "vaperbr", "vapetricks", "ejuicebrasil","ejuicesbr","vaping","vapeclassy","vapelife","vapefam","premiumeliquid","ejuicepron","vapeon","ecigshop","vapedaily","eliquid","vapepics",], // recommended more than 20
		...
		"likemode_competitor_users": {
			"account": "_vapevapor", // instagram nickname
			"likeday_min": "800",      // min like daily.
			"likeday_max": "900",      // max like daily. In 2018 limit instagram is 1000/day
			"sleep_night": "disabled",  // if you need stop bot in night
			"sleep_end": "7:00",        // sleep from 00:00 to 7:00 am
